...
This was a weekend project that I decided to vibe code since I don't have an interest in learning javascript, that allowed me to block out my ideas and get a feel for what I want to do with the native linux desktop app. I will attempt to learn and program the native application with my own skills, but I knew I wanted an online version, and this is the result.
